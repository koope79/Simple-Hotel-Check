        ...
        <Form>
          <div className={s.searchBar}>
            <div className={s.barBlock}>
              ...
              {errors.loca && touched.loca && (
                <div className={classnames(s.errorField, { [s.errorFieldColor]: errors.loca })}>
                  {errors.loca}
                </div>
              )}
            </div>
            <div className={s.barBlock}>
              ...
              {errors.date && touched.date && (
                <div className={classnames(s.errorField, { [s.errorFieldColor]: errors.date })}>
                  {errors.date}
                </div>
              )}
            </div>
            <div className={s.barBlock}>
              ...
              <div className={s.barBlock_input}>
                <Field
                  type={"text"}
                  name={"days"}
                  validate={requiredCountDays}
                  placeholder={"1"}
                />
              </div>
              {errors.days && touched.days && (
                <div className={classnames(s.errorField, { [s.errorFieldColor]: errors.days })}>
                  {errors.days}
                </div>
              )}
            </div>
